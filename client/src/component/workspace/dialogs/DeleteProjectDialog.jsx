...
export default function DeleteProjectDialog({ open, handleClose }) {
    ...
    const deleteProjectInWorkspace = useProjectStore(state => state.deleteProjectInWorkspace)
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                <Box sx={{
                    ...
                    <Typography variant="subtitle1" textAlign='center' sx={{ color: '#991B1B', fontWeight: 700 }}>
                        "{selectedProjectInWorkspace.projectName} - {selectedProjectInWorkspace.status}"
                    </Typography>
                </Box>
            ...
            <DialogActions sx={{ justifyContent: 'center', pb: 3, gap: 1 }}>
                ...
                <Button
                    onClick={() => handleDelete(selectedProjectInWorkspace._id)}
                    variant="contained"
                    sx={{
                        borderRadius: '999px',
                        px: 4,

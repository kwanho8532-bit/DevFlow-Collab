...
export default function TaskEditConfirm({ open, handleClose, prevObj, changeObj, formId }) {
        ...
        >
            <DialogTitle id="alert-dialog-title" sx={{ pt: 2 }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                    <Stack direction='row' spacing={1.5} justifyContent='center' alignItems='center'>
                        ...
                        <ArrowForwardIcon sx={{ color: '#4c1d95', fontSize: '1.2rem' }} />
                        <Typography variant="h6" sx={{ color: '#4c1d95', fontWeight: 800 }}>
            ...
            <DialogContent>
                <DialogContentText id="status-dialog-description" component="div">
                    ...
                    <Typography variant="caption" sx={{ color: '#4c1d95' }}>
